...
.cpv-btn {
	...
	gap: 8px;
	padding: 13px 28px;
	background: var(--cpv-btn-bg, #6366F1);
	color: var(--cpv-btn-text, #fff);
	border: none;
	border-radius: 10px;
	font-family: 'Archivo', -apple-system, BlinkMacSystemFont, sans-serif;
	font-size: 14px;
	...
	box-shadow: 0 3px 12px var(--cpv-btn-shadow, rgba(99,102,241,.3));
}

.cpv-btn:hover {
	background: var(--cpv-btn-hover, #4F46E5);
...
export default function PortalVerify() {
	...
	const btnStyleVars = {
		'--cpv-btn-bg': btnColors.bg,
		'--cpv-btn-hover': btnColors.hover,
		'--cpv-btn-text': btnColors.text,
		'--cpv-btn-shadow': btnColors.shadow,
	};
	...
	return (
		<div className="cpv-page">
			<div className="cpv-card" style={ btnStyleVars }>
