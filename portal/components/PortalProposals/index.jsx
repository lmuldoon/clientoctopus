...
.cpp-tab:hover { border-color: var(--cpp-btn-bg, #6366F1); color: var(--cpp-btn-bg, #6366F1); }

.cpp-tab.cpp-tab-active {
	background: var(--cpp-btn-bg, #6366F1);
	border-color: var(--cpp-btn-bg, #6366F1);
	color: var(--cpp-btn-text, #fff);
	font-weight: 600;
}
...
export default function PortalProposals() {
	...
	const btnStyleVars = {
		'--cpp-btn-bg': btnColors.bg,
		'--cpp-btn-text': btnColors.text,
	};
